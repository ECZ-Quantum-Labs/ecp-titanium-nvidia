...
- **Model Endpoint:** `nvidia/nemotron-3.5-lightning-30b-a3b`
...
'''
        ...
        report_path = "ecp-titanium-nvidia/benchmarks/BENCHMARK_NVIDIA_CLOUD.md"
        os.makedirs(os.path.dirname(report_path), exist_ok=True)
        with open(report_path, "w", encoding="utf-8") as f:
            f.write(report)

        print("[+] Benchmark report generated: ecp-titanium-nvidia/benchmarks/BENCHMARK_NVIDIA_CLOUD.md")

if __name__ == "__main__":
    run_nvidia_live_benchmark()
"""

path = "ecp-titanium-nvidia/benchmarks/run_benchmark.py"
os.makedirs(os.path.dirname(path), exist_ok=True)
with open(path, "w", encoding="utf-8") as f:
    f.write(benchmark_script)

print("[+] Benchmark runner created successfully.")